            ...
            <div className="bg-[#111]">
                <div className="p-3">
                    ...
                    <div className="flex items-center justify-between py-4">
                        <h1 class="text-pink-500 hover:text-fuchsia-700 cursor-pointer text-xs font-semibold">Visit demo</h1>
                    </div>
                </div>
            </div>
        </div>
